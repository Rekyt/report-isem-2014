...
We used a previously developed demographic and quantitative genetics models (see~\nameref{sec:M&M}), and implemented environmental fluctuations, neglecting phenotypic plasticity. Using a process-based model describing the phenology and life cycle of Oak trees we estimated those fluctuations in optimal trait values.