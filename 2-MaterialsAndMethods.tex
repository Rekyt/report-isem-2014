...
\begin{align}
	...
	&\quad + v_{I} u_{M} s_{0} \overline{f_{2}}(\overline{z}) + v_{M} u_{I} m s_{M} + v_{M} u_{M} s_M \\
	\frac{d\overline{\lambda}(\overline{z})}{d\overline{z}} &= v_{I} u_{I} \left[ \frac{d\overline{f_{1}}(\overline{z})}{d\overline{z}} m s_{0} + (1-m) \frac{d\overline{s_{I}}(\overline{z})}{d\overline{z}} \right] \nonumber \\
	&\quad + v_{I} u_{M} s_{0} \frac{d\overline{f_{2}}(\overline{z})}{d\overline{z}}
\end{align}