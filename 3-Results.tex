...
We excluded those extreme events to estimate the trend in the variation of $\theta_f$ (see~\nameref{sec:M&M}). Using linear regression on $\theta_f$ with time, we found a rate of $-0.15$ \si{\day\per\year}, with normal residuals having a variance of $93.1$ day^2 (data not shown, $R^2=0.2435$, $p=1.185e-07$, $F=32.5$ with $101$ d.f.).
